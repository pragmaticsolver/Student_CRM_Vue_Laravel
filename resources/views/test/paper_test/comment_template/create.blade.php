...
@section('content')
    <div class="row justify-content-center">
        ...
        <div class="col-12">
	        <form method="POST" action="{{ route('comment_template.store') }}">
	        	@csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <textarea name="content_en" class="form-control" rows="7"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <textarea name="content_ja" class="form-control" rows="7"></textarea>
                    </div>
                </div>
